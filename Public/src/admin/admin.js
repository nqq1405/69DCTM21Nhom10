...
(function () {
	...
	function selectMenuItem(url) {
		require(['translator'], function (translator) {
			...
			var mainTitle;
			var pageTitle;
			if (/admin\/general\/manage$/.test(url)) {
				pageTitle = '[[admin/menu:general/manage/categories]]';
				mainTitle = pageTitle;
				...
				if (matches) {
					...
					mainTitle = '[[admin/menu:manage/categories]]';
					pageTitle = '[[admin/menu:manage/categories]]';
				}
			}
